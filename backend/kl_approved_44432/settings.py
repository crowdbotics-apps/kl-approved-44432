"""
Django settings for kl_approved_44432 project.
...
ROOT_URLCONF = 'kl_approved_44432.urls'
...
WSGI_APPLICATION = 'kl_approved_44432.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kl_approved_44432 API",
    "DESCRIPTION": "API documentation for kl_approved_44432 App",
    "VERSION": "v1",
}
